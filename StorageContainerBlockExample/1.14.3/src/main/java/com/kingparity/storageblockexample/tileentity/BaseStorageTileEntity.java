...
public abstract class BaseStorageTileEntity extends LockableTileEntity implements IInventory
{
    private final String ID;
    protected NonNullList<ItemStack> inventory;
    protected ITextComponent customName;
    
    public BaseStorageTileEntity(TileEntityType<?> tileEntityType, String id, int inventorySize)
    {
